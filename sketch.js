...
function setup(){
   ...
   // log1 = new Log(810,260,300, PI/2);
    ...
    box15 = new Box(960,170,50,70);
    box16 = new Box(1000,240,50,70);

    box17 = new Box(865,100,50,70);
    box18 = new Box(935,100,50,70);

    box19 = new Box(460,300,50,70);
    box20 = new Box(540,300,50,70);

   box21 = new Box(495,200,50,70);
